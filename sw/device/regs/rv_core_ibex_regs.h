...
#define RV_CORE_IBEX_ALERT_TEST_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_SW_RECOV_ERR_REG_RESVAL 0x9u
#define RV_CORE_IBEX_SW_RECOV_ERR_VAL_MASK 0xfu
...
#define RV_CORE_IBEX_SW_FATAL_ERR_REG_RESVAL 0x9u
#define RV_CORE_IBEX_SW_FATAL_ERR_VAL_MASK 0xfu
...
#define RV_CORE_IBEX_IBUS_REGWEN_0_REG_RESVAL 0x1u
#define RV_CORE_IBEX_IBUS_REGWEN_0_EN_0_BIT 0
#define RV_CORE_IBEX_IBUS_REGWEN_0_EN_0_VALUE_LOCKED 0x0
#define RV_CORE_IBEX_IBUS_REGWEN_0_EN_0_VALUE_ENABLED 0x1

// Ibus address control regwen.
#define RV_CORE_IBEX_IBUS_REGWEN_1_REG_OFFSET 0x10
#define RV_CORE_IBEX_IBUS_REGWEN_1_REG_RESVAL 0x1u
#define RV_CORE_IBEX_IBUS_REGWEN_1_EN_1_BIT 0

// Enable Ibus address matching (common parameters)
...
#define RV_CORE_IBEX_IBUS_ADDR_EN_0_REG_RESVAL 0x0u
#define RV_CORE_IBEX_IBUS_ADDR_EN_0_EN_0_BIT 0

// Enable Ibus address matching
#define RV_CORE_IBEX_IBUS_ADDR_EN_1_REG_OFFSET 0x18
#define RV_CORE_IBEX_IBUS_ADDR_EN_1_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_IBUS_ADDR_MATCHING_0_REG_RESVAL 0x0u

//   Matching region programming for ibus.
#define RV_CORE_IBEX_IBUS_ADDR_MATCHING_1_REG_OFFSET 0x20
#define RV_CORE_IBEX_IBUS_ADDR_MATCHING_1_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_IBUS_REMAP_ADDR_0_REG_RESVAL 0x0u

//   The remap address after a match has been made.
#define RV_CORE_IBEX_IBUS_REMAP_ADDR_1_REG_OFFSET 0x28
#define RV_CORE_IBEX_IBUS_REMAP_ADDR_1_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_DBUS_REGWEN_0_REG_RESVAL 0x1u
#define RV_CORE_IBEX_DBUS_REGWEN_0_EN_0_BIT 0
#define RV_CORE_IBEX_DBUS_REGWEN_0_EN_0_VALUE_LOCKED 0x0
#define RV_CORE_IBEX_DBUS_REGWEN_0_EN_0_VALUE_ENABLED 0x1

// Dbus address control regwen.
#define RV_CORE_IBEX_DBUS_REGWEN_1_REG_OFFSET 0x30
#define RV_CORE_IBEX_DBUS_REGWEN_1_REG_RESVAL 0x1u
#define RV_CORE_IBEX_DBUS_REGWEN_1_EN_1_BIT 0

// Enable dbus address matching (common parameters)
...
#define RV_CORE_IBEX_DBUS_ADDR_EN_0_REG_RESVAL 0x0u
#define RV_CORE_IBEX_DBUS_ADDR_EN_0_EN_0_BIT 0

// Enable dbus address matching
#define RV_CORE_IBEX_DBUS_ADDR_EN_1_REG_OFFSET 0x38
#define RV_CORE_IBEX_DBUS_ADDR_EN_1_REG_RESVAL 0x0u
#define RV_CORE_IBEX_DBUS_ADDR_EN_1_EN_1_BIT 0

// See !!IBUS_ADDR_MATCHING_0 for detailed description. (common parameters)
...
#define RV_CORE_IBEX_DBUS_ADDR_MATCHING_0_REG_RESVAL 0x0u

// See !!IBUS_ADDR_MATCHING_0 for detailed description.
#define RV_CORE_IBEX_DBUS_ADDR_MATCHING_1_REG_OFFSET 0x40
#define RV_CORE_IBEX_DBUS_ADDR_MATCHING_1_REG_RESVAL 0x0u

// See !!IBUS_REMAP_ADDR_0 for a detailed description. (common parameters)
...
#define RV_CORE_IBEX_DBUS_REMAP_ADDR_0_REG_RESVAL 0x0u

// See !!IBUS_REMAP_ADDR_0 for a detailed description.
#define RV_CORE_IBEX_DBUS_REMAP_ADDR_1_REG_OFFSET 0x48
#define RV_CORE_IBEX_DBUS_REMAP_ADDR_1_REG_RESVAL 0x0u

// Enable mask for NMI.
#define RV_CORE_IBEX_NMI_ENABLE_REG_OFFSET 0x4c
#define RV_CORE_IBEX_NMI_ENABLE_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_NMI_STATE_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_ERR_STATUS_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_RND_DATA_REG_RESVAL 0x0u

// Status of random data in !!RND_DATA
#define RV_CORE_IBEX_RND_STATUS_REG_OFFSET 0x5c
#define RV_CORE_IBEX_RND_STATUS_REG_RESVAL 0x0u
...
#define RV_CORE_IBEX_FPGA_INFO_REG_RESVAL 0x0u
