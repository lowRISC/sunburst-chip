...
#define SPI_HOST_CONFIGOPTS_CLKDIV_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_CLKDIV_MASK, .index = SPI_HOST_CONFIGOPTS_CLKDIV_OFFSET })
#define SPI_HOST_CONFIGOPTS_CSNIDLE_MASK 0xfu
#define SPI_HOST_CONFIGOPTS_CSNIDLE_OFFSET 16
#define SPI_HOST_CONFIGOPTS_CSNIDLE_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_CSNIDLE_MASK, .index = SPI_HOST_CONFIGOPTS_CSNIDLE_OFFSET })
#define SPI_HOST_CONFIGOPTS_CSNTRAIL_MASK 0xfu
#define SPI_HOST_CONFIGOPTS_CSNTRAIL_OFFSET 20
#define SPI_HOST_CONFIGOPTS_CSNTRAIL_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_CSNTRAIL_MASK, .index = SPI_HOST_CONFIGOPTS_CSNTRAIL_OFFSET })
#define SPI_HOST_CONFIGOPTS_CSNLEAD_MASK 0xfu
#define SPI_HOST_CONFIGOPTS_CSNLEAD_OFFSET 24
#define SPI_HOST_CONFIGOPTS_CSNLEAD_FIELD \
  ((bitfield_field32_t) { .mask = SPI_HOST_CONFIGOPTS_CSNLEAD_MASK, .index = SPI_HOST_CONFIGOPTS_CSNLEAD_OFFSET })
