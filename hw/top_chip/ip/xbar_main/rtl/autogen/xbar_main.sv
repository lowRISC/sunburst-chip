...
module xbar_main (
  ...
  tl_h2d_t tl_asf_10_us_h2d ;
  tl_d2h_t tl_asf_10_us_d2h ;
  tl_h2d_t tl_asf_10_ds_h2d ;
  tl_d2h_t tl_asf_10_ds_d2h ;
  ...
  assign tl_revocation_ram_o = tl_s1n_9_ds_h2d[2];
  assign tl_s1n_9_ds_d2h[2] = tl_revocation_ram_i;

  assign tl_asf_10_us_h2d = tl_s1n_9_ds_h2d[3];
  assign tl_s1n_9_ds_d2h[3] = tl_asf_10_us_d2h;

  assign tl_s1n_6_us_h2d = tl_rv_core_ibex__corei_i;
  assign tl_rv_core_ibex__corei_o = tl_s1n_6_us_d2h;

  assign tl_sram_o = tl_sm1_7_ds_h2d;
  assign tl_sm1_7_ds_d2h = tl_sram_i;

  assign tl_rom_o = tl_sm1_8_ds_h2d;
  assign tl_sm1_8_ds_d2h = tl_rom_i;

  assign tl_s1n_9_us_h2d = tl_rv_core_ibex__cored_i;
  assign tl_rv_core_ibex__cored_o = tl_s1n_9_us_d2h;

  assign tl_peri_o = tl_asf_10_ds_h2d;
  assign tl_asf_10_ds_d2h = tl_peri_i;
  ...
  tlul_fifo_async #(
    ...
    .tl_h_i       (tl_asf_10_us_h2d),
    .tl_h_o       (tl_asf_10_us_d2h),
    .tl_d_o       (tl_asf_10_ds_h2d),
    .tl_d_i       (tl_asf_10_ds_d2h)
  );
